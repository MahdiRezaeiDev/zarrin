<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('پس از حذف حساب شما، تمام منابع و داده های آن برای همیشه حذف می شوند. قبل از حذف حساب خود، لطفاً هر داده یا اطلاعاتی را که می‌خواهید حفظ کنید، دانلود کنید.') }}
        </p>
    </header>
        ...
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <div class="mt-6">
                ...
                <x-text-input
                    ...
                    placeholder="{{ __('رمزعبورتان را وارد نمایید.') }}"
                />
